...
filenames <- list.files("~/XG/Chinese League One 2025", pattern="*.json", full.names=TRUE)
...
matches <- read.csv("/Users/user/XG/Chinese League One 2025 Matches.csv") %>%
...
for(i in 1:length(filenames)){
  ...
  write.csv(Wedstrijd, glue::glue('~/XG/Chinese League One 2025/xgCSV/{gsub(".json","",str_split_fixed(filenames[i], n=6,pattern = "/")[6])}.csv'))
  #######
